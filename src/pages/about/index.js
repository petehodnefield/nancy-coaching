  ...
  return (
    <main className="coaching">
      ...
      <section className="section__container section__continer--xtra-padding">
        <Image className="cover section__bg-img" src={speakingImage} />
        <div className="section-card__wrapper">
          <div className="section-card section-card--white  rounded-lg">
            ...
            <p className="section-card__text section-card__text-mgsm">
              I'm Nancy, a passionate professional coach dedicated to guiding
              and mentoring young female professionals like you. I firmly
              believe that every woman has incredible potential waiting to be
              unleashed, and it's our mission to help you tap into that power
              and achieve the success and fulfillment you deserve.
            </p>
            <p className="section-card__text section-card__text-mgsm">
              ...
              Through years of experience and personal growth, I've developed a
              coaching approach tailored specifically to address these
              challenges head-on. Together, we'll navigate through any
              roadblocks, harness your strengths, and create a clear path to
            ...
            <p className="section-card__text">
              ...
              your authentic self. Together, we'll uncover your true potential
      ...
      <section className="section__container section__continer--xtra-padding">
        <div className="section-card__wrapper section-card__wrapper--relative">
          ...
          <div className="section-card section-card--relative section-card--white section-card--xl rounded-lg">
            ...
            <p className="section-card__text section-card__text-mgsm">
              Through personalized one-on-one coaching sessions, we'll delve
              deep into your unique circumstances, goals, and aspirations. We'll
              work together to identify and overcome any limiting beliefs,
              develop effective strategies, and enhance your skills and
              capabilities. Whether you're looking to advance in your current
              role, transition to a new career, or establish your own business,
              our coaching sessions will provide you with the tools and insights
              to make it happen.
            </p>
            <p className="section-card__text section-card__text-mgsm">
              In addition to individual coaching, we also offer workshops and
              group sessions where you'll have the opportunity to connect with
              like-minded young professionals. These sessions provide a
        ...
        <div className="section-card__wrapper section-card__wrapper--column">
          <div className="section-card section-card--white rounded-lg">
            ...
            <p className="section-card__text section-card__text-mgsm ">
              ...
              designed to meet your specific needs and goals. Here's what you
              can anticipate along the way:
            </p>
            <ol className="section-card__ol">
              <li className="section-card__text ">
                <span className="bold">Discovery: </span>We'll start by getting
                to know each other and understanding your current situation,
                goals, and aspirations. This phase allows us to establish a
                strong foundation and create a roadmap for your coaching
                journey.
              </li>
              <li className="section-card__text">
                <span className="bold">Exploration: </span>Through
                thought-provoking conversations and powerful questioning, we'll
                delve deep into your values, strengths, and passions. We'll
                uncover any limiting beliefs or barriers and develop strategies
                to overcome them.
              </li>
              <li className="section-card__text">
                <span className="bold">Action: </span> Armed with a clear vision
                and concrete goals, we'll develop an actionable plan to help you
                make steady progress towards your objectives. We'll identify
                specific steps, milestones, and accountability measures to
                ensure your success.
              </li>
            </ol>
          </div>
      ...
      <section className="section__container">
        ...
        <div className="section-cta__wrapper">
          <div className="section-cta">
            <h2 className="title title--uppercase">Let's get started</h2>
            <h3 className="title title--lg">
